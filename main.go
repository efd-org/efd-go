...
<head>
    ...
    <title>EFD Go Welcome</title>
    <style>
        :root { --bg: #1f0d0d; --panel: #ffffff; --accent: #ef4444; --text: #0f172a; --muted: #64748b; }
        * { box-sizing: border-box; }
        body { margin: 0; font-family: 'Segoe UI', Arial, sans-serif; background: linear-gradient(135deg, var(--bg), #3b1111); color: var(--text); min-height: 100vh; display: grid; place-items: center; padding: 24px; }
...
<body>
    <div class="card">
        <div class="badge">EFD • Go</div>
        <h1>%s</h1>
        <p>This polished welcome page is served from the Go project and is ready to be viewed in a browser.</p>
    </div>
</body>
</html>`, getGreeting())
}
